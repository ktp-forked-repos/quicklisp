...
;; Time-stamp: <2011-01-30 18:34:56EST unit-definitions.lisp>
...
(define-units 'angle
    `((radian    1.0                (rad radians) "rad")
      ...
      (arcminute (/ degree 60)      (arcmin arcminutes arc-minute arc-minutes))
      (arcsecond (/ arcminute 60)   (arcsec arcseconds arc-second arc-seconds))
      (revolution (* 2 ,pi)         (rev orbit))))
