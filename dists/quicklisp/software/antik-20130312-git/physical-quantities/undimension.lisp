...
;; Time-stamp: <2011-08-03 10:52:43AKDT undimension.lisp>
...
#+example
(without-units ()
  (multiple-value-bind (mag inpunits) (pqwu #_4_km)
...
(defmacro without-units
    ((&optional (system-of-units '*system-of-units*)) &body body)
