...
;; Time-stamp: <2011-10-02 14:16:44EDT grid.lisp>
...
(defun make-pq-grid
    (magnitude unit-expressions &optional (sysunits *system-of-units*))
  ...
  (loop with unit-array = (make-array (grid:dimensions magnitude))
	...
	for pq-elt = (make-pq-ue (grid:aref* magnitude i) (grid:aref* ue i) sysunits)
	do
