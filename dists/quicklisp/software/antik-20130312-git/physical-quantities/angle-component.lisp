...
;; Time-stamp: <2011-08-03 10:58:49AKDT angle-component.lisp>
...
(defparameter *half-rev* #_1/2_revolution)
...
(defmethod pq-magnitude :before ((angle angle))
  ...
  (with-angle angle
	...
	(setf normalized
      ...
      (setf magnitude
	    (pqval (antik:+ normalized
			    (make-pq whole-revolutions 'revolution)) nil *siu*)))))
  ...
  (if (check-dimension angle 'angle nil)
	...
	(with-pq ((angle angle))
	  ...
	  (with-angle angle
		...
		(normalize-angle (pqval angle 'radian) positive)
