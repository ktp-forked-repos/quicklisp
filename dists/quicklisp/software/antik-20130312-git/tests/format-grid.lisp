...
;; Time-stamp: <2013-02-02 10:05:47EST format-grid.lisp>
...
(defun formatting-test-grid (foreign-array matrix pq)
  ...
  (let ((numgrid 
	 (grid::test-grid-double-float
	  (if foreign-array 'grid:foreign-array 'array)
	  (if (eq pq :mixed)
	      '(2)
	      (if matrix '(4 4) '(5))))))
    (case pq
...
(defparameter *all-formatting-test-grids*
  (list
   (formatting-test-grid nil nil nil)
   (formatting-test-grid nil nil :scalar)
   (formatting-test-grid nil nil :mixed)
   (formatting-test-grid nil t nil)
   (formatting-test-grid nil t :scalar)
   (formatting-test-grid nil t :mixed)
   (formatting-test-grid t nil nil)
   (formatting-test-grid t nil :scalar)
   (formatting-test-grid t nil :mixed)
   (formatting-test-grid t t nil)
   (formatting-test-grid t t :scalar)
   (formatting-test-grid t t :mixed))
