...
;; Time-stamp: <2012-11-24 15:46:32EST functions.lisp>

;; Copyright 2010, 2011, 2012 Liam M. Healy
...
(export '(*grid-types* gridp grid rank dimensions
...
(defun gridp (object)
  ...
  (or (antik::pq-gridp object)
      (find-if (lambda (type) (typep object type)) *grid-types*)))
