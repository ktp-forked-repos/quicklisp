...
;; Time-stamp: <2012-05-30 15:32:09EDT indexed.lisp>
...
;;;  - maybe make the input (file, stream, string) a kind of grid without random access, unless stream can be rewound; then you could just "copy-to" the grid you wanted.
