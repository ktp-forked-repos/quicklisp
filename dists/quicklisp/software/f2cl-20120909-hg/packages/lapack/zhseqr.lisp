  ...
  (defun zhseqr (job compz n ilo ihi h ldh w z ldz work lwork info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((initz nil) (lquery nil) (wantt nil) (wantz nil) (kbot 0) (nmin 0)
       ...
       end_label
        (return
         (values nil nil n nil nil nil ldh nil nil ldz nil lwork info))))))

(in-package #-gcl #:cl-user #+gcl "CL-USER")
#+#.(cl:if (cl:find-package '#:f2cl) '(and) '(or))
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zhseqr fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil fortran-to-lisp::n nil nil nil fortran-to-lisp::ldh nil nil fortran-to-lisp::ldz
                            nil fortran-to-lisp::lwork fortran-to-lisp::info)
           :calls '(fortran-to-lisp::zlahqr fortran-to-lisp::ilaenv fortran-to-lisp::zlaset fortran-to-lisp::zcopy
                    fortran-to-lisp::zlaqr0 fortran-to-lisp::xerbla fortran-to-lisp::lsame))))
