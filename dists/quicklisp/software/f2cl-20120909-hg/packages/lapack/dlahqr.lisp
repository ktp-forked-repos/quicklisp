...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dlahqr fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::drot fortran-to-lisp::dlanv2 fortran-to-lisp::dlarfg fortran-to-lisp::dcopy
                    fortran-to-lisp::dlanhs fortran-to-lisp::dlabad fortran-to-lisp::dlamch))))
