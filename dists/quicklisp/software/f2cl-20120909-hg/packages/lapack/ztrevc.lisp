...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::ztrevc fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((simple-string) (simple-string) (array fortran-to-lisp::logical (*))
                        ...
                        (fortran-to-lisp::integer4) (array fortran-to-lisp::complex16 (*)) (array double-float (*))
                        (fortran-to-lisp::integer4))
           :return-values '(nil nil nil nil nil fortran-to-lisp::ldt nil nil nil nil nil fortran-to-lisp::m nil nil
                            fortran-to-lisp::info)
           :calls '(fortran-to-lisp::zgemv fortran-to-lisp::zdscal fortran-to-lisp::izamax fortran-to-lisp::zcopy
                    fortran-to-lisp::dzasum fortran-to-lisp::dlabad fortran-to-lisp::dlamch fortran-to-lisp::xerbla
