...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zlahr2 fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil fortran-to-lisp::k fortran-to-lisp::nb nil fortran-to-lisp::lda nil nil nil nil
                            fortran-to-lisp::ldy)
           :calls '(fortran-to-lisp::zgemm fortran-to-lisp::ztrmm fortran-to-lisp::zscal fortran-to-lisp::zlarfg
                    fortran-to-lisp::zaxpy fortran-to-lisp::ztrmv fortran-to-lisp::zcopy fortran-to-lisp::zgemv))))
