...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zlaqr3 fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '(fortran-to-lisp::logical fortran-to-lisp::logical (fortran-to-lisp::integer4)
                        (fortran-to-lisp::integer4) (fortran-to-lisp::integer4) (fortran-to-lisp::integer4)
                        (array fortran-to-lisp::complex16 (*)) (fortran-to-lisp::integer4) (fortran-to-lisp::integer4)
                        (fortran-to-lisp::integer4) (array fortran-to-lisp::complex16 (*)) (fortran-to-lisp::integer4)
                        (fortran-to-lisp::integer4) (fortran-to-lisp::integer4) (array fortran-to-lisp::complex16 (*))
                        (array fortran-to-lisp::complex16 (*)) (fortran-to-lisp::integer4) (fortran-to-lisp::integer4)
                        (array fortran-to-lisp::complex16 (*)) (fortran-to-lisp::integer4) (fortran-to-lisp::integer4)
                        (array fortran-to-lisp::complex16 (*)) (fortran-to-lisp::integer4)
                        (array fortran-to-lisp::complex16 (*)) (fortran-to-lisp::integer4))
           :return-values '(nil nil nil nil nil nil nil fortran-to-lisp::ldh nil nil nil fortran-to-lisp::ldz
                            fortran-to-lisp::ns fortran-to-lisp::nd nil nil fortran-to-lisp::ldv nil nil
                            fortran-to-lisp::ldt nil nil fortran-to-lisp::ldwv nil fortran-to-lisp::lwork)
           :calls '(fortran-to-lisp::zgemm fortran-to-lisp::zlarf fortran-to-lisp::zlarfg fortran-to-lisp::ztrexc
                    fortran-to-lisp::zlahqr fortran-to-lisp::ilaenv fortran-to-lisp::zcopy fortran-to-lisp::dlabad
                    fortran-to-lisp::dlamch fortran-to-lisp::zunmhr fortran-to-lisp::zgehrd))))
