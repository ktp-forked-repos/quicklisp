...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dtrexc fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((simple-string) (fortran-to-lisp::integer4) (array double-float (*))
           ...
           :return-values '(nil nil nil nil nil nil fortran-to-lisp::ifst fortran-to-lisp::ilst nil
                            fortran-to-lisp::info)
           :calls '(fortran-to-lisp::dlaexc fortran-to-lisp::xerbla fortran-to-lisp::lsame))))
