...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dlaqtr fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '(fortran-to-lisp::logical fortran-to-lisp::logical (fortran-to-lisp::integer4)
                        (array double-float (*)) (fortran-to-lisp::integer4) (array double-float (*)) (double-float)
                        (double-float) (array double-float (*)) (array double-float (*)) (fortran-to-lisp::integer4))
           :return-values '(nil nil nil nil nil nil nil fortran-to-lisp::scale nil nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::dladiv fortran-to-lisp::ddot fortran-to-lisp::dlaln2 fortran-to-lisp::daxpy
                    fortran-to-lisp::dscal fortran-to-lisp::idamax fortran-to-lisp::dasum fortran-to-lisp::dlange
