...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dlasq2 fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((fortran-to-lisp::integer4) (array double-float (*)) (fortran-to-lisp::integer4))
           :return-values '(nil nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::dlasq3 fortran-to-lisp::ilaenv fortran-to-lisp::dlasrt fortran-to-lisp::xerbla
