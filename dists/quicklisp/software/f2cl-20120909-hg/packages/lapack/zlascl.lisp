...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zlascl fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((simple-string) (fortran-to-lisp::integer4) (fortran-to-lisp::integer4) (double-float)
                        (double-float) (fortran-to-lisp::integer4) (fortran-to-lisp::integer4)
           ...
           :calls '(fortran-to-lisp::dlamch fortran-to-lisp::xerbla fortran-to-lisp::disnan fortran-to-lisp::lsame))))
