                      ...
                      (multiple-value-bind
                          ...
                          (zlaqr5 wantt wantz kacc22 n ktop kbot ns
                           ...
                           (f2cl-lib:array-slice h-%data%
                                                 ...
                                                 h-%offset%)
                           ldh)
                        (declare (ignore var-7 var-8 var-12 var-14 var-15
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zlaqr4 fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(fortran-to-lisp::wantt fortran-to-lisp::wantz fortran-to-lisp::n nil nil nil
                            fortran-to-lisp::ldh nil fortran-to-lisp::iloz fortran-to-lisp::ihiz nil
                            fortran-to-lisp::ldz nil nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::zlaqr2 fortran-to-lisp::ilaenv fortran-to-lisp::zlahqr))))
