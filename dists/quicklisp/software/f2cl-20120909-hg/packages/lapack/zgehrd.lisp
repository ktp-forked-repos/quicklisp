...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zgehrd fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil fortran-to-lisp::ihi nil fortran-to-lisp::lda nil nil nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::zgehd2 fortran-to-lisp::zaxpy fortran-to-lisp::ztrmm fortran-to-lisp::zgemm
                    fortran-to-lisp::zlahr2 fortran-to-lisp::xerbla fortran-to-lisp::ilaenv))))
