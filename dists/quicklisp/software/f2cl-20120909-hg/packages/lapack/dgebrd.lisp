...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dgebrd fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::dgebd2 fortran-to-lisp::dgemm fortran-to-lisp::dlabrd fortran-to-lisp::xerbla
