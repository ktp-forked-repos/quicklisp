  ...
  (defun zgeev (jobvl jobvr n a lda w vl ldvl vr ldvr work lwork rwork info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((dum (make-array 1 :element-type 'double-float))
              ...
              (cond
                (wantvl
                 ...
                 (multiple-value-bind
                   ...
                   (declare (ignore var-0 var-1 var-3 var-4 var-5 var-7 var-8
                                    var-10 var-11))
                   (setf n var-2)
                   (setf lda var-6)
                   (setf ldvl var-9)
        ...
        (cond
          (wantvl
           ...
           (multiple-value-bind
             ...
             (declare (ignore var-0 var-1 var-3 var-4 var-5 var-7 var-8 var-10
                              var-11))
             (setf n var-2)
             (setf lda var-6)
             (setf ldvl var-9)
       ...
       end_label
        (return
         (values nil nil n nil lda nil nil ldvl nil ldvr nil nil nil info))))))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zgeev fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((simple-string) (simple-string) (fortran-to-lisp::integer4)
                        (array fortran-to-lisp::complex16 (*)) (fortran-to-lisp::integer4)
                        (array fortran-to-lisp::complex16 (*)) (array fortran-to-lisp::complex16 (*))
                        (fortran-to-lisp::integer4) (array fortran-to-lisp::complex16 (*)) (fortran-to-lisp::integer4)
                        (array fortran-to-lisp::complex16 (*)) (fortran-to-lisp::integer4) (array double-float (*))
                        (fortran-to-lisp::integer4))
           :return-values '(nil nil fortran-to-lisp::n nil fortran-to-lisp::lda nil nil fortran-to-lisp::ldvl nil
                            fortran-to-lisp::ldvr nil nil nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::zscal fortran-to-lisp::idamax fortran-to-lisp::zdscal fortran-to-lisp::dznrm2
                    fortran-to-lisp::zgebak fortran-to-lisp::ztrevc fortran-to-lisp::zunghr fortran-to-lisp::zlacpy
                    fortran-to-lisp::zgehrd fortran-to-lisp::zgebal fortran-to-lisp::zlascl fortran-to-lisp::zlange
                    fortran-to-lisp::dlabad fortran-to-lisp::dlamch fortran-to-lisp::xerbla fortran-to-lisp::zhseqr
