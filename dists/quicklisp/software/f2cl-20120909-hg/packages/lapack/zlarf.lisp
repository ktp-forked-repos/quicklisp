  ...
  (setf (gethash 'fortran-to-lisp::zlarf fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((simple-string) (fortran-to-lisp::integer4) (fortran-to-lisp::integer4)
                        (array fortran-to-lisp::complex16 (*)) (fortran-to-lisp::integer4) (fortran-to-lisp::complex16)
                        (array fortran-to-lisp::complex16 (*)) (fortran-to-lisp::integer4)
                        (array fortran-to-lisp::complex16 (*)))
           :return-values '(nil fortran-to-lisp::m fortran-to-lisp::n nil nil nil nil fortran-to-lisp::ldc nil)
           :calls '(fortran-to-lisp::zgerc fortran-to-lisp::zgemv fortran-to-lisp::lsame))))
