...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zgehd2 fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil fortran-to-lisp::ihi nil fortran-to-lisp::lda nil nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::zlarf fortran-to-lisp::zlarfg fortran-to-lisp::xerbla))))
