...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zunmqr fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(fortran-to-lisp::side fortran-to-lisp::trans fortran-to-lisp::m fortran-to-lisp::n
                            fortran-to-lisp::k nil fortran-to-lisp::lda nil nil fortran-to-lisp::ldc nil nil
                            fortran-to-lisp::info)
           :calls '(fortran-to-lisp::xerbla fortran-to-lisp::ilaenv fortran-to-lisp::lsame))))
