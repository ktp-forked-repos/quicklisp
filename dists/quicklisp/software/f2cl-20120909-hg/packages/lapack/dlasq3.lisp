...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dlasq3 fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((fortran-to-lisp::integer4) (fortran-to-lisp::integer4) (array double-float (*))
                        (fortran-to-lisp::integer4) (double-float) (double-float) (double-float) (double-float)
                        (fortran-to-lisp::integer4) (fortran-to-lisp::integer4) (fortran-to-lisp::integer4)
                        fortran-to-lisp::logical)
           :return-values '(nil fortran-to-lisp::n0 nil nil fortran-to-lisp::dmin fortran-to-lisp::sigma
                            fortran-to-lisp::desig fortran-to-lisp::qmax fortran-to-lisp::nfail fortran-to-lisp::iter
                            fortran-to-lisp::ndiv nil)
           :calls '(fortran-to-lisp::dlasq6 fortran-to-lisp::dlasq5 fortran-to-lisp::dlasq4 fortran-to-lisp::dlamch))))
