...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zlatrs fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((simple-string) (simple-string) (simple-string) (simple-string) (fortran-to-lisp::integer4)
                        ...
                        (array fortran-to-lisp::complex16 (*)) (double-float) (array double-float (*))
                        (fortran-to-lisp::integer4))
           :return-values '(nil nil nil nil nil nil nil nil fortran-to-lisp::scale nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::zdotc fortran-to-lisp::zdotu fortran-to-lisp::izamax fortran-to-lisp::zaxpy
                    fortran-to-lisp::zladiv fortran-to-lisp::zdscal fortran-to-lisp::ztrsv fortran-to-lisp::dscal
                    fortran-to-lisp::idamax fortran-to-lisp::dzasum fortran-to-lisp::dlabad fortran-to-lisp::dlamch
