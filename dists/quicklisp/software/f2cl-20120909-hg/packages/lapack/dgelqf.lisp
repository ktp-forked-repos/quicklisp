...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dgelqf fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::dlarfb fortran-to-lisp::dlarft fortran-to-lisp::dgelq2 fortran-to-lisp::xerbla
