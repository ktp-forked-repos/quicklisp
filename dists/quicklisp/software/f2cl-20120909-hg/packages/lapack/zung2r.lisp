...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zung2r fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil fortran-to-lisp::lda nil nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::zscal fortran-to-lisp::zlarf fortran-to-lisp::xerbla))))
