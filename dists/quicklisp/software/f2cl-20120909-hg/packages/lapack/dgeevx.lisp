...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dgeevx fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((simple-string) (simple-string) (simple-string) (simple-string) (fortran-to-lisp::integer4)
                        (array double-float (*)) (fortran-to-lisp::integer4) (array double-float (*))
                        (array double-float (*)) (array double-float (*)) (fortran-to-lisp::integer4)
                        (array double-float (*)) (fortran-to-lisp::integer4) (fortran-to-lisp::integer4)
                        (fortran-to-lisp::integer4) (array double-float (*)) (double-float) (array double-float (*))
                        (array double-float (*)) (array double-float (*)) (fortran-to-lisp::integer4)
                        (array fortran-to-lisp::integer4 (*)) (fortran-to-lisp::integer4))
           :return-values '(nil nil nil nil nil nil nil nil nil nil nil nil nil fortran-to-lisp::ilo
                            fortran-to-lisp::ihi nil fortran-to-lisp::abnrm nil nil nil nil nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::drot fortran-to-lisp::dlartg fortran-to-lisp::idamax fortran-to-lisp::dlapy2
                    fortran-to-lisp::dscal fortran-to-lisp::dnrm2 fortran-to-lisp::dgebak fortran-to-lisp::dtrsna
                    fortran-to-lisp::dtrevc fortran-to-lisp::dhseqr fortran-to-lisp::dorghr fortran-to-lisp::dlacpy
                    fortran-to-lisp::dgehrd fortran-to-lisp::dgebal fortran-to-lisp::dlascl fortran-to-lisp::dlange
                    fortran-to-lisp::dlabad fortran-to-lisp::dlamch fortran-to-lisp::xerbla fortran-to-lisp::ilaenv
