...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dgehrd fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::dgehd2 fortran-to-lisp::dlarfb fortran-to-lisp::dgemm fortran-to-lisp::dlahrd
