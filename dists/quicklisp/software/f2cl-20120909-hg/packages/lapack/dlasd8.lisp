...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dlasd8 fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::dcopy fortran-to-lisp::ddot fortran-to-lisp::dlasd4 fortran-to-lisp::dlaset
                    fortran-to-lisp::dlascl fortran-to-lisp::dnrm2 fortran-to-lisp::dlamc3 fortran-to-lisp::xerbla))))
