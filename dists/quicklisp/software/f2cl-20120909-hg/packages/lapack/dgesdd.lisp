...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dgesdd fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((simple-string) (fortran-to-lisp::integer4) (fortran-to-lisp::integer4)
           ...
           :calls '(fortran-to-lisp::dorglq fortran-to-lisp::dgelqf fortran-to-lisp::dorgbr fortran-to-lisp::dgemm
                    fortran-to-lisp::dormbr fortran-to-lisp::dorgqr fortran-to-lisp::dlacpy fortran-to-lisp::dbdsdc
                    fortran-to-lisp::dgebrd fortran-to-lisp::dlaset fortran-to-lisp::dgeqrf fortran-to-lisp::dlascl
                    fortran-to-lisp::dlange fortran-to-lisp::dlamch fortran-to-lisp::xerbla fortran-to-lisp::ilaenv
