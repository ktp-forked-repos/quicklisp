...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dbdsdc fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((simple-string) (simple-string) (fortran-to-lisp::integer4) (array double-float (*))
                        ...
                        (array fortran-to-lisp::integer4 (*)) (array double-float (*))
           ...
           :calls '(fortran-to-lisp::dlasr fortran-to-lisp::dswap fortran-to-lisp::dlasda fortran-to-lisp::dlasd0
                    fortran-to-lisp::dlamch fortran-to-lisp::dlascl fortran-to-lisp::dlanst fortran-to-lisp::dlaset
                    fortran-to-lisp::dlasdq fortran-to-lisp::dlartg fortran-to-lisp::dcopy fortran-to-lisp::ilaenv
