...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dlanv2 fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((double-float) (double-float) (double-float) (double-float) (double-float) (double-float)
                        (double-float) (double-float) (double-float) (double-float))
           :return-values '(fortran-to-lisp::a fortran-to-lisp::b fortran-to-lisp::c fortran-to-lisp::d
                            fortran-to-lisp::rt1r fortran-to-lisp::rt1i fortran-to-lisp::rt2r fortran-to-lisp::rt2i
