...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dormbr fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((simple-string) (simple-string) (simple-string) (fortran-to-lisp::integer4)
           ...
           :calls '(fortran-to-lisp::dormlq fortran-to-lisp::dormqr fortran-to-lisp::xerbla fortran-to-lisp::ilaenv
