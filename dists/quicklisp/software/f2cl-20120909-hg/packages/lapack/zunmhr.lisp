  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i1 0) (i2 0) (iinfo 0) (lwkopt 0) (mi 0) (nb 0) (nh 0) (ni 0)
      ...
      (multiple-value-bind
        ...
        (declare (ignore var-5 var-7 var-8 var-10 var-11))
        (setf side var-0)
        (setf trans var-1)
        (setf mi var-2)
        (setf ni var-3)
     ...
     end_label
      (return
       (values side trans nil nil nil nil nil lda nil nil ldc nil nil info)))))

(in-package #-gcl #:cl-user #+gcl "CL-USER")
#+#.(cl:if (cl:find-package '#:f2cl) '(and) '(or))
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zunmhr fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((simple-string) (simple-string) (fortran-to-lisp::integer4) (fortran-to-lisp::integer4)
           ...
           :return-values '(fortran-to-lisp::side fortran-to-lisp::trans nil nil nil nil nil fortran-to-lisp::lda nil
                            nil fortran-to-lisp::ldc nil nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::zunmqr fortran-to-lisp::xerbla fortran-to-lisp::ilaenv fortran-to-lisp::lsame))))
