...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zgebak fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::zswap fortran-to-lisp::zdscal fortran-to-lisp::xerbla fortran-to-lisp::lsame))))
