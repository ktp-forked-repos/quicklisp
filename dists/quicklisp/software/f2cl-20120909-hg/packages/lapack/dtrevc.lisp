...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dtrevc fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil nil nil nil fortran-to-lisp::m nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::ddot fortran-to-lisp::dgemv fortran-to-lisp::idamax fortran-to-lisp::dcopy
                    fortran-to-lisp::daxpy fortran-to-lisp::dscal fortran-to-lisp::dlaln2 fortran-to-lisp::dlabad
