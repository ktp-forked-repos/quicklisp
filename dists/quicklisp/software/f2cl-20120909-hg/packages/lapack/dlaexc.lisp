...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dlaexc fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '(fortran-to-lisp::logical (fortran-to-lisp::integer4) (array double-float (*))
           ...
           :return-values '(nil nil nil nil nil nil nil nil nil nil fortran-to-lisp::info)
           :calls '(fortran-to-lisp::dlanv2 fortran-to-lisp::dlarfx fortran-to-lisp::dlarfg fortran-to-lisp::dlasy2
                    fortran-to-lisp::dlamch fortran-to-lisp::dlange fortran-to-lisp::dlacpy fortran-to-lisp::drot
