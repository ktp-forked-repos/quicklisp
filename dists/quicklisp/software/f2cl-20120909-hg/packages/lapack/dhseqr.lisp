...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dhseqr fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::dlarfx fortran-to-lisp::dlarfg fortran-to-lisp::dlapy2 fortran-to-lisp::dscal
                    fortran-to-lisp::idamax fortran-to-lisp::dgemv fortran-to-lisp::dcopy fortran-to-lisp::dlacpy
                    fortran-to-lisp::dlanhs fortran-to-lisp::dlabad fortran-to-lisp::dlamch fortran-to-lisp::dlahqr
                    fortran-to-lisp::ilaenv fortran-to-lisp::dlaset fortran-to-lisp::xerbla fortran-to-lisp::lsame))))
